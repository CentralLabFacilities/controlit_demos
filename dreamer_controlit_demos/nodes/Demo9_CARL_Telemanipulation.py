...
class TrajectoryPush(smach.State):
    ...
    def __init__(self, dreamerInterface, prevTraj, goBackToReadyState):
        ...
        self.trajReach.addRHCartWP([0.3246641813985473, -0.2682061882567273, 1.1225699272165688])
        self.trajReach.addRHCartWP([0.3177270681690219, -0.3198845479960411, 1.136781694923583])
        self.trajReach.addRHCartWP([0.3088317409767023, -0.363519775835606, 1.0827597675139629])
        self.trajReach.addRHCartWP([0.29807184157478334, -0.3772161004836367, 1.0270219378121788])
        self.trajReach.addRHCartWP([0.2918545125781099, -0.34991820389649486, 0.9863700293580815])
        self.trajReach.addRHCartWP([0.29255692823217366, -0.34084198509588765, 0.9831724553795478])


        self.trajReach.addRHOrientWP([0.32089361951308976, -0.9413416405768688, 0.10441839240209305])
        self.trajReach.addRHOrientWP([0.16439144818984558, -0.9633765309477029, 0.21185162586398712])
        self.trajReach.addRHOrientWP([0.028918665108324762, -0.9933492536749694, 0.11144941019015663])
        self.trajReach.addRHOrientWP([-0.05603352121971035, -0.9977910088313529, 0.03568399073858675])
        self.trajReach.addRHOrientWP([-0.03995214634563561, -0.9962163249939348, -0.0771806958892949])
        self.trajReach.addRHOrientWP([-0.03433786569158176, -0.9946388027076238, -0.09754262210998545])
        ...
        self.trajPush.addRHCartWP([0.29182512742411687, -0.3370423367542359, 0.981642290657445])
        self.trajPush.addRHCartWP([0.30340530291832885, -0.2819964609333591, 0.9759358333757678])
        self.trajPush.addRHCartWP([0.31056714834970994, -0.19705303396896817, 0.9575657340481442])
        self.trajPush.addRHCartWP([0.3180583129352426, -0.14849172695934806, 0.9827913572657686])
        self.trajPush.addRHCartWP([0.3205842678737202, -0.09809343612954594, 0.987575421323227])
        self.trajPush.addRHCartWP([0.3145868127841851, -0.021002988686408215, 0.9777725735393638])

        self.trajPush.addRHOrientWP([-0.051629334244851104, -0.993490993000863, -0.10153845907631669])
        self.trajPush.addRHOrientWP([0.09202482341232027, -0.9901679101652122, -0.10535151425104164])
        self.trajPush.addRHOrientWP([0.14114845709697718, -0.9889513843420926, -0.04530201393979374])
        self.trajPush.addRHOrientWP([0.14614792617743622, -0.9889138623065175, 0.02627083196324037])
        self.trajPush.addRHOrientWP([0.20085089181138968, -0.9779455180637022, 0.05728422957225016])
        self.trajPush.addRHOrientWP([0.5313835708658435, -0.8470153292322848, -0.014019010642297576])
